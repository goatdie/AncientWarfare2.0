...
namespace Figurebox
{
public class WarinfoWindow : MonoBehaviour
{
    ...
    {
        // 获取Scroll View对象
        var scrollView = GameObject.Find($"/Canvas Container Main/Canvas - Windows/windows/warinfoWindow/Background/Scroll View");
    ...
    {
        // 显示窗口
        Windows.ShowWindow("warinfoWindow");
