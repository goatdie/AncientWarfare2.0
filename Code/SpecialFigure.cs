...
namespace Figurebox
{
    ...
    internal class SpecialFigure
    {
        ...
        public int nameCount
        {
            get
            {
                return SpecialFigure.SpawnedNames.Count;
            }
        }
        ...
        public static void Historical_Postfix(ActorManager __instance, ActorData pData, Actor __result)
        {
            ...
            ActorData actorStatus = Reflection.GetField(__result.GetType(), __result, "data") as ActorData;
            Race race = Reflection.GetField(__result.GetType(), __result, "race") as Race;
            BaseStats actorStats = Reflection.GetField(__result.GetType(), __result, "stats") as BaseStats; //狗马把一堆名字换了
            ...
            if (race.civilization && !hasFirstTrait)
            {
                ...
                if ((Toolbox.randomChance(0.8f)) && !SpecialFigure.SpawnedNames.ContainsKey(text0))// random stuff
                {
                    if (__result == null)
                    {
                        return;
                    ...
                    SpecialFigure.SpawnedNames.Add(text0, true);
                ...
                string text2 = "嬴政";
                if ((Toolbox.randomChance(0.005f)) && !SpecialFigure.SpawnedNames.ContainsKey(text2))
                {
                    if (__result == null)
                    {
                        return;
                    ...
                    actorStatus.favorite = true;
                    actorStatus.health = 1500;
                    SpecialFigure.SpawnedNames.Add(text2, true);
                    __result.addTrait("figure");
                ...
                string text3 = "刘邦";
                if ((Toolbox.randomChance(0.005f)) && !SpecialFigure.SpawnedNames.ContainsKey(text3))
                {
                    if (__result == null)
                    {
                        return;
                    ...
                    actorStatus.set("name_set", true);
                    SpecialFigure.SpawnedNames.Add(text3, true);
                    __result.addTrait("figure");
                    actorStatus.favorite = true;
                    actorStatus.health = 1500;
                    __result.addTrait("first");
                ...
                string text5 = "曹丕";
                if ((Toolbox.randomChance(0.005f)) && !SpecialFigure.SpawnedNames.ContainsKey(text5))
                {
                    if (__result == null)
                    {
                        return;
